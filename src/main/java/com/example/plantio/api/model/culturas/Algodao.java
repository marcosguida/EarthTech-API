...
@Entity
@DiscriminatorValue("algodao")
public class Algodao extends Zoneamento {

    public Algodao(Long id, String safra, String cultura, String uf, String municipio, String grupo, String solo,
