...
@Entity
@DiscriminatorValue("milho")
public class Milho extends Zoneamento {

    public Milho(Long id, String safra, String cultura, String uf, String municipio, String grupo, String solo,
