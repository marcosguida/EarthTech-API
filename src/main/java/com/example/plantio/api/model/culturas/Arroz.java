...
@Entity
@DiscriminatorValue("arroz")
public class Arroz extends Zoneamento {

    public Arroz(Long id, String safra, String cultura, String uf, String municipio, String grupo, String solo,
