...
@Entity
@DiscriminatorValue("soja")
public class Soja extends Zoneamento {

    public Soja(Long id, String safra, String cultura, String uf, String municipio, String grupo, String solo,
